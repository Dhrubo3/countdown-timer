...
public class MainActivity extends AppCompatActivity {
    ...
    private final long starTime =  50 * 1000;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CountDownTimer countDownTimer = new  CountDownTimer(starTime, interval){

            @Override
            public void onTick(long millisUntilFinished) {
                txtTimer.setText("Time: " + millisUntilFinished/1000);
                txtTimerElapsed.setText("Time elapsed: " + (starTime - millisUntilFinished));
            }
